        ...
        <table cellpadding="1" cellspacing="1" id="editDetails" class="transparent">
            <tbody>
                <tr>
                    ...
                    ?>
                    <th class="birth"><?php echo OVERVIEW22; ?></th>
                    <td class="birth">
                        <input tabindex="1" class="text day" type="text" name="tag" style="width:15px;" value="<?php echo $bday[2]; ?>" maxlength="2" /> <select tabindex="2" name="monat" size="" class="dropdown">
                            ...
                            <option value="1" <?php if ($bday[1] == 1) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW23; ?></option>
                            <option value="2" <?php if ($bday[1] == 2) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW24; ?></option>
                            <option value="3" <?php if ($bday[1] == 3) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW25; ?></option>
                            <option value="4" <?php if ($bday[1] == 4) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW26; ?></option>
                            <option value="5" <?php if ($bday[1] == 5) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW27; ?></option>
                            <option value="6" <?php if ($bday[1] == 6) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW28; ?></option>
                            ...
                            <option value="8" <?php if ($bday[1] == 8) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW30; ?></option>
                            <option value="9" <?php if ($bday[1] == 9) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW31; ?></option>
                            <option value="10" <?php if ($bday[1] == 10) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW32; ?></option>
                            <option value="11" <?php if ($bday[1] == 11) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW33; ?></option>
                            <option value="12" <?php if ($bday[1] == 12) {
                                                    echo "selected";
                                                } ?>><?php echo OVERVIEW34; ?></option>
                        </select> <input style="width:25px;" tabindex="3" type="text" name="jahr" value="<?php echo $bday[0]; ?>" maxlength="4" class="text year">
                    </td>
                ...
                <tr>
                    ...
                    <td class="gend">
                        <label><input class="radio" type="radio" name="mw" value="0" <?php if ($userv['gender'] == 0) {
                                                                                            echo "checked";
                                                                                        } ?> tabindex="4">-</label>
                        <label><input class="radio" type="radio" name="mw" value="1" <?php if ($userv['gender'] == 1) {
                                                                                            echo "checked";
                                                                                        } ?>><?= OVERVIEW39 ?></label>
                        <label><input class="radio" type="radio" name="mw" value="2" <?php if ($userv['gender'] == 2) {
                                                                                            echo "checked";
                                                                                        } ?>><?= OVERVIEW40 ?></label>
                    </td>
                </tr>
